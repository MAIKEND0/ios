//
//  ChefProjectDetailView.swift - UPDATED with Task Detail Navigation
//  KSR Cranes App
//
//  Detailed project view for Chef role with working task navigation
//
...
struct ChefProjectDetailView: View {
    ...
    @State private var selectedTask: ProjectTask? // ✅ ADDED: State for task selection
    ...
    var body: some View {
        NavigationStack {
            ...
            // ✅ ADDED: Navigation to task detail
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            RoundedRectangle(cornerRadius: 4)
                                ...
                                .frame(width: geometry.size.width * (completion / 100), height: 8)
                                .animation(.easeInOut, value: completion)
                        }
                    }
                    .frame(height: 8)
                }
